...
export default function Footer() {
  const whatsappNumber = "+971 585589552"; // without '+'
  ...
  return (
    <>
      <a
        ...
        className="fixed bottom-3 lg:bottom-5 right-3 lg:right-5 z-50 w-14 h-14 rounded-full shadow-lg flex justify-center items-center hover:scale-105 transition-transform duration-300"
      >
        {/* Radiating pulse effect */}
        <span className="absolute w-14 h-14 rounded-full animate-ping bg-[#25D366] opacity-40"></span>
        <span className="absolute w-14 h-14 rounded-full animate-ping bg-[#25D366] opacity-30 delay-150"></span>
        <span className="absolute w-14 h-14 rounded-full animate-ping bg-[#25D366] opacity-20 delay-300"></span>
        ...
        <div className="footer-info bg-[#2d7372] text-white relative">
          <div className="container mx-auto px-5 md:px-12 xl:px-32 pt-8">
            <div className="flex flex-col gap-y-10 lg:flex-row lg:gap-x-5 justify-between mb-8">
              ...
              <div className="flex gap-x-10 md:gap-x-20 lg:gap-x-28">
            ...
            <div className="py-5 container mx-auto relative z-10">
              <div className="md:flex flex-wrap lg:justify-center gap-x-2 items-center text-sm text-white justify-center">
                <p className="text-center text-white hover:text-gray-100 transition-colors duration-200">
                  © {new Date().getFullYear()} Agricare Planet All rights
                  reserved. <i>Designed by Future IT Touch Pvt Ltd</i>
                </p>
              </div>
            </div>
          </div>
